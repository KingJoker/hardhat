...
export declare class BlockchainData {
    ...
    getTransaction(transactionHash: Buffer): import("@ethereumjs/tx").AccessListEIP2930Transaction | import("@ethereumjs/tx").FeeMarketEIP1559Transaction | import("@ethereumjs/tx").Transaction | undefined;
