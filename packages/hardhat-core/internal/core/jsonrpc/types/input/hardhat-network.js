...
exports.rpcForkConfig = io_ts_1.optional(t.type({
    jsonRpcUrl: t.string,
    blockNumber: io_ts_1.optional(t.number),
}, "RpcForkConfig"));
exports.rpcHardhatNetworkConfig = t.type({
    forking: io_ts_1.optional(exports.rpcForkConfig),
}, "HardhatNetworkConfig");
exports.optionalRpcHardhatNetworkConfig = io_ts_1.optional(exports.rpcHardhatNetworkConfig);
