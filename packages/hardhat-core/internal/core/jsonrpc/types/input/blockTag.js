...
exports.rpcNewBlockTagObjectWithHash = t.type({
    ...
    requireCanonical: io_ts_1.optionalOrNullable(t.boolean),
});
...
exports.optionalRpcNewBlockTag = io_ts_1.optionalOrNullable(exports.rpcNewBlockTag);
...
exports.optionalRpcOldBlockTag = io_ts_1.optionalOrNullable(exports.rpcOldBlockTag);
